{
  "patcher": {
    ...
    "gridsize": [15.0, 15.0],
    "boxes": [
      {"box": {"id": "obj-1", "maxclass": "comment", "patching_rect": [30.0, 20.0, 420.0, 20.0], "text": "tuning_engine: midi/chord interval -> tuned frequencies"}},
      {"box": {"id": "obj-2", "maxclass": "newobj", "text": "inlet", "patching_rect": [30.0, 60.0, 35.0, 22.0], "numinlets": 1, "numoutlets": 1}},
      {"box": {"id": "obj-3", "maxclass": "newobj", "text": "js ../code/tuning_engine.js", "patching_rect": [30.0, 100.0, 200.0, 22.0], "numinlets": 1, "numoutlets": 2}},
    ...
    "originid": "pat-temperamentlab-tuning",
    "autosave": 0
  }
}
